...
<head>
    ...
    <!-- Main CSS-->
    <link href="../css/dashboard_karyawan.css" rel="stylesheet" type="text/css" media="all" />
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    <h2 class="title-1" style="text-align: center;">Selamat Datang <?php echo $r['nama']; ?>, Silahkan Absen</h2>
                            ...
                            <form action="dt_absen_sv.php" method="post">
                                ...
                                <table class="table table-borderless table-striped table-earning" >
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>Nama</td>
                                                <td><input type="text" class="form-control" name="nama" autocomplete="off" readonly="" value="<?php echo $r['nama']; ?>"></td>
                                            </tr>
